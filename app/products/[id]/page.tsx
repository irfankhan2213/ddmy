          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="flex-1 bg-zinc-900 border border-zinc-800 text-white font-extrabold text-sm sm:text-base py-4 rounded-xl hover:bg-zinc-800 active:scale-[0.99] transition-all flex items-center justify-center gap-2 uppercase tracking-wider"
              >
